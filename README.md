...
```
./rtabmap-mbari DATASET_ROOT_PATH LEFT_IMAGE_FOLDER RIGHT_IMAGE_FOLDER LEFT_CALIB_YAML RIGHT_CALIB_YAML CALIBRATION_FILE_PATH  
```
or 
```
./rtabmap-mbari DATASET_ROOT_PATH LEFT_IMAGE_FOLDER RIGHT_IMAGE_FOLDER LEFT_CALIB_YAML RIGHT_CALIB_YAML CALIBRATION_FILE_PATH --imu_data_file IMU_CSV_FILE --imu_calib_file IMU_CALIB_YAML  
```
